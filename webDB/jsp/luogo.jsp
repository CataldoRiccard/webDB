     ...
     if(request.getParameter("luogo")==null || request.getParameter("luogo").isEmpty()){
      ...
      <h1>Elenco dei giudici di <%= request.getParameter("luogo") %></h1>
        <% 
            ...
            String connectionUrl = "jdbc:sqlserver://213.140.22.237\\SQLEXPRESS:1433;databaseName=XFactor;user=cataldo.riccardo;password=xxx123#";
			...
			stmt1.setString(1,request.getParameter("luogo"));
